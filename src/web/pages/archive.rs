        ...
        section class="transcript-section" {
            ...
            details open {
                ...
                div id="transcript-content"
                    ...
                    style="max-height: var(--video-rendered-height, 800px); overflow-y: auto; padding: 1rem; background: var(--bg-tertiary); border: 1px solid var(--border-color); font-family: monospace; white-space: pre-wrap; line-height: 1.6; color: var(--text-primary);" {
                    "Loading transcript..."
                }
